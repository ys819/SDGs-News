    ...
    <div className={classes.root} alignContent='flex-start' >
      ...
      <Paper className={classes.paper}>
        <Grid container spacing={2}>
          <Grid item>
              <img className={classes.img} alt="complex" src={item.img} width='200' />
          </Grid>
          <Grid item xs={12} sm container>
            <Grid item xs container direction="column" spacing={2}>
              <Grid item xs>
                <Typography gutterBottom variant="h5" color='palette.success.dark'>
                  {item.title}
                </Typography>
            ...
            <Grid item>
              <Typography variant="subtitle1">{item.num}</Typography>
            </Grid>
          </Grid>
        </Grid>
      </Paper>
